...
/**
 * Write a description of class Date_CLIENT here.
 *
 * @author (your name)
...
public class Date_CLIENT
{
    ...
    Date d1 = new Date(2001,1,1);
        ...
        /*
        Rectangle rect1= new Rectangle(3,15,5,9);
        Rectangle rect2 = new Rectangle(5,5,7,3);
        Rectangle rect3 = new Rectangle(10,17,14,4);
        Rectangle rect1 = new Rectangle(2,17,8,4);
        Rectangle rect2= new Rectangle(8,15,4,9);
        Rectangle rect3=new Rectangle(0,20,4,4);
        Rectangle rect5=new Rectangle(-2,16,6,5);
        Rectangle rect4 =rect1.intersection(rect3);
        System.out.println(rect4.toString());
        //Rectangle[x=3,y=5,width=9,height=19]*/
